	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        {field:'j_id',title:'ID',width:50, sortable: true},
 		        {field:'title',title:'名称',width:100},
                {field:'dept',title:'部门',width:100},
                {field:'base_wage',title:'基本工资',width:100},
                {field:'classn',title:'头衔',width:100,
 		        },
	 		]], 
	        toolbar: "#toolbar"
	    }); 
...
<body>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
		<div><a id="add" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">添加部门</a></div>
	</div>
